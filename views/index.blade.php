...
<body data-spy="scroll" data-target="#navbarSupportedContent">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    @if (!Auth::user())
                        <button class="btn btn-success" type="submit" onclick="location.href = '/admin/login'">Đăng nhập</button>
                        <button class="btn btn-success" type="submit" onclick="location.href = '/admin/register'">Đăng ký</button>
                    @else
                        ...
                        <button class="btn btn-danger" style="background: #dc3545" type="submit" onclick="location.href = '/admin/logout'">Đăng xuất</button>
                    @endif
                </div>
            </div>
        </nav>
            ...
            <div class="text col-lg-12 col-md-12 col-12  pb-5">
                ...
                <form class="align-items-center container my-5 mx-auto w-50" action="index.php" method="get">
                    ...
                    <div class="alert alert-success">
                        Kết quả: <strong id="result"></strong>
                    </div>
    ...
    <footer class="page-footer font-small-stylish-color-dark pt-4 text-light" id="contactus">
        ...
        <ul class="list-unstyled list-inline text-center py-2">
            ...
            <li class="list-inline-item">
                <a href="/admin/register" class="btn btn-danger btn-rounded">Đăng ký</a>
            </li>
        </ul>
        <hr>
